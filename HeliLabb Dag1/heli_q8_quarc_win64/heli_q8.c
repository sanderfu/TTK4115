...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_FrontmotorSaturation = heli_q8_DW.HILReadEncoderTimebase_Buffer[0];
        rtb_BackmotorSaturation = heli_q8_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Sum1 = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Sum1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Sum1 = 0.0;
    } else {
      rtb_Sum1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_Sum1 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_Sum1 = 0.0;
    } else {
      rtb_Sum1 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S4>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_Sum1 *
      heli_q8_P.Joystick_gain_y;

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/Constant3'
     */
    rtb_Sum1 = heli_q8_P.v_s0 + heli_q8_B.Joystick_gain_y;

    /* Gain: '<S1>/Back gain' incorporates:
     *  Sum: '<S1>/Subtract'
     */
    rtb_BackmotorSaturation = (rtb_Sum1 + heli_q8_B.Joystick_gain_x) *
      heli_q8_P.Backgain_Gain;

    /* Gain: '<S1>/Front gain' incorporates:
     *  Sum: '<S1>/Add'
     */
    rtb_FrontmotorSaturation = (rtb_Sum1 - heli_q8_B.Joystick_gain_x) *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S2>/Sum'
     */
    heli_q8_B.K_ei = (heli_q8_P.Constant1_Value - heli_q8_B.Add) *
      heli_q8_P.K_ei_Gain;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S5>/Gain' */
    heli_q8_B.Gain = heli_q8_P.k_1 * heli_q8_B.Joystick_gain_x;

    /* Gain: '<S5>/Gain1' incorporates:
     *  Constant: '<S5>/Constant'
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.Gain1 = (rtb_Sum1 - heli_q8_P.v_s0) * heli_q8_P.k_2;
  }

  /* Gain: '<S5>/Gain2' */
  heli_q8_B.Gain2 = heli_q8_P.k_3 * heli_q8_B.Integrator3;
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator2_CSTATE = heli_q8_B.Gain;
