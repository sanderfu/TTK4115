 ...
 * C source code generated on : Thu Nov 14 00:10:07 2019
 *
...
void heli_q81_output0(void)            /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_TmpSignalConversionAtGainIn[2];
  real_T rtb_Sum1[2];
  int32_T i;
  real_T tmp[5];
  int32_T i_0;
  ...
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    ...
    if (heli_q81_B.RateTransitiony > heli_q81_P.DeadZoney_End) {
      rtb_PulseGenerator = heli_q81_B.RateTransitiony - heli_q81_P.DeadZoney_End;
    } else if (heli_q81_B.RateTransitiony >= heli_q81_P.DeadZoney_Start) {
      rtb_PulseGenerator = 0.0;
    } else {
      rtb_PulseGenerator = heli_q81_B.RateTransitiony -
     ...
     *  Gain: '<S4>/Gain: y'
     */
    heli_q81_B.Joystick_gain_y = heli_q81_P.Gainy_Gain * rtb_PulseGenerator *
  ...
  heli_q81_B.ElevationTransferFcn = 0.0;
  heli_q81_B.ElevationTransferFcn += heli_q81_P.ElevationTransferFcn_C *
    heli_q81_X.ElevationTransferFcn_CSTATE;
  heli_q81_B.ElevationTransferFcn += heli_q81_P.ElevationTransferFcn_D *
    heli_q81_B.ElevationCounttorad;
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    /* DiscretePulseGenerator: '<S2>/Pulse Generator' */
    rtb_PulseGenerator = (heli_q81_DW.clockTickCounter <
                          heli_q81_P.PulseGenerator_Duty) &&
      (heli_q81_DW.clockTickCounter >= 0) ? heli_q81_P.PulseGenerator_Amp : 0.0;
    if (heli_q81_DW.clockTickCounter >= heli_q81_P.PulseGenerator_Period - 1.0)
    {
      heli_q81_DW.clockTickCounter = 0;
    } else {
      heli_q81_DW.clockTickCounter++;
    }

    /* End of DiscretePulseGenerator: '<S2>/Pulse Generator' */

    /* DiscretePulseGenerator: '<S2>/Pulse Generator1' */
    rtb_PulseGenerator1 = (heli_q81_DW.clockTickCounter_m <
      heli_q81_P.PulseGenerator1_Duty) && (heli_q81_DW.clockTickCounter_m >= 0) ?
      heli_q81_P.PulseGenerator1_Amp : 0.0;
    if (heli_q81_DW.clockTickCounter_m >= heli_q81_P.PulseGenerator1_Period -
        1.0) {
      heli_q81_DW.clockTickCounter_m = 0;
    } else {
      heli_q81_DW.clockTickCounter_m++;
    }

    /* End of DiscretePulseGenerator: '<S2>/Pulse Generator1' */

    /* Switch: '<S2>/Switch' incorporates:
     *  Constant: '<S2>/Enable pitch square'
     *  Gain: '<S2>/Gain'
     *  Sum: '<S2>/Sum1'
     */
    if (heli_q81_P.Enablepitchsquare_Value > heli_q81_P.Switch_Threshold) {
      heli_q81_B.Switch = heli_q81_P.Gain_Gain * rtb_PulseGenerator +
        rtb_PulseGenerator1;
    } else {
      heli_q81_B.Switch = heli_q81_P.Enablepitchsquare_Value;
    }
    ...
    rtb_TmpSignalConversionAtGainIn[0] = heli_q81_B.Switch;
    rtb_TmpSignalConversionAtGainIn[1] = heli_q81_B.Joystick_gain_y;

    /* Gain: '<S6>/Gain' incorporates:
     *  SignalConversion: '<S5>/TmpSignal ConversionAtGainInport1'
     */
    heli_q81_B.Gain[0] = 0.0;
    heli_q81_B.Gain[0] += heli_q81_P.F[0] * heli_q81_B.Switch;
    heli_q81_B.Gain[0] += heli_q81_P.F[2] * heli_q81_B.Joystick_gain_y;
    heli_q81_B.Gain[1] = 0.0;
    heli_q81_B.Gain[1] += heli_q81_P.F[1] * heli_q81_B.Switch;
    heli_q81_B.Gain[1] += heli_q81_P.F[3] * heli_q81_B.Joystick_gain_y;
  }

  /* TransferFcn: '<S3>/Pitch: Transfer Fcn' */
  heli_q81_B.PitchTransferFcn = 0.0;
  heli_q81_B.PitchTransferFcn += heli_q81_P.PitchTransferFcn_C *
    heli_q81_X.PitchTransferFcn_CSTATE;
  heli_q81_B.PitchTransferFcn += heli_q81_P.PitchTransferFcn_D *
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_Sum1[i] = heli_q81_B.Gain[i] - ((heli_q81_P.K[i + 2] *
      heli_q81_B.PitchTransferFcn + heli_q81_P.K[i] * heli_q81_B.PitchCounttorad)
      + heli_q81_P.K[i + 4] * heli_q81_B.ElevationTransferFcn);
  }

  /* End of Sum: '<S6>/Sum1' */
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    /* Constant: '<Root>/Turn on//of integral effect (1=off)' */
    heli_q81_B.Turnonofintegraleffect1off =
      heli_q81_P.Turnonofintegraleffect1off_Valu;

    /* Gain: '<S5>/Gain' */
    heli_q81_B.Gain_d[0] = 0.0;
    heli_q81_B.Gain_d[0] += heli_q81_P.F_aug[0] *
      rtb_TmpSignalConversionAtGainIn[0];
    heli_q81_B.Gain_d[0] += heli_q81_P.F_aug[2] *
      rtb_TmpSignalConversionAtGainIn[1];
    heli_q81_B.Gain_d[1] = 0.0;
    heli_q81_B.Gain_d[1] += heli_q81_P.F_aug[1] *
      rtb_TmpSignalConversionAtGainIn[0];
    heli_q81_B.Gain_d[1] += heli_q81_P.F_aug[3] *
      rtb_TmpSignalConversionAtGainIn[1];
  }

  /* SignalConversion: '<S5>/TmpSignal ConversionAtGain1Inport1' incorporates:
   *  Integrator: '<S5>/Integrator'
   *  Integrator: '<S5>/Integrator1'
   */
  tmp[0] = heli_q81_B.PitchCounttorad;
  tmp[1] = heli_q81_B.PitchTransferFcn;
  tmp[2] = heli_q81_B.ElevationTransferFcn;
  tmp[3] = heli_q81_X.Integrator_CSTATE;
  tmp[4] = heli_q81_X.Integrator1_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    rtb_PulseGenerator = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_PulseGenerator += heli_q81_P.K_aug[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_TmpSignalConversionAtGainIn[i] = heli_q81_B.Gain_d[i] -
      rtb_PulseGenerator;
  }
  ...
  /* Switch: '<Root>/Switch' */
  if (heli_q81_B.Turnonofintegraleffect1off > heli_q81_P.Switch_Threshold_l) {
    heli_q81_B.Switch_a = rtb_Sum1[1];
  } else {
    heli_q81_B.Switch_a = rtb_TmpSignalConversionAtGainIn[1];
  }

  /* End of Switch: '<Root>/Switch' */
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    /* Constant: '<S6>/Constant2' */
    heli_q81_B.Constant2 = heli_q81_P.v_s0;

    /* Constant: '<S5>/Constant2' */
    heli_q81_B.Constant2_k = heli_q81_P.v_s0;

    /* Constant: '<Root>/Constant2' */
    heli_q81_B.Constant2_e = heli_q81_P.v_s0;
  }
   ...
   *  Sum: '<S6>/Sum2'
   */
  if (heli_q81_B.Turnonofintegraleffect1off > heli_q81_P.Switch1_Threshold) {
    rtb_PulseGenerator = heli_q81_B.Constant2 + rtb_Sum1[0];
  } else {
    rtb_PulseGenerator = heli_q81_B.Constant2_k +
      rtb_TmpSignalConversionAtGainIn[0];
  }
  ...
  /* Sum: '<Root>/Sum1' */
  heli_q81_B.Sum1 = rtb_PulseGenerator - heli_q81_B.Constant2_e;
  if (rtmIsMajorTimeStep(heli_q81_M)) {
  ...
  heli_q81_B.TravelTransferFcn = 0.0;
  heli_q81_B.TravelTransferFcn += heli_q81_P.TravelTransferFcn_C *
    heli_q81_X.TravelTransferFcn_CSTATE;
  heli_q81_B.TravelTransferFcn += heli_q81_P.TravelTransferFcn_D *
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_PulseGenerator1 = (rtb_PulseGenerator - heli_q81_B.Switch_a) *
    heli_q81_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_PulseGenerator1 > heli_q81_P.FrontmotorSaturation_UpperSat) {
    heli_q81_B.FrontmotorSaturation = heli_q81_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_PulseGenerator1 < heli_q81_P.FrontmotorSaturation_LowerSat) {
    heli_q81_B.FrontmotorSaturation = heli_q81_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q81_B.FrontmotorSaturation = rtb_PulseGenerator1;
  }
  ...
  if (rtb_PulseGenerator1 > heli_q81_P.BackmotorSaturation_UpperSat) {
    heli_q81_B.BackmotorSaturation = heli_q81_P.BackmotorSaturation_UpperSat;
  } else if (rtb_PulseGenerator1 < heli_q81_P.BackmotorSaturation_LowerSat) {
    heli_q81_B.BackmotorSaturation = heli_q81_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q81_B.BackmotorSaturation = rtb_PulseGenerator1;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    ...
    if (heli_q81_B.RateTransitionx > heli_q81_P.DeadZonex_End) {
      rtb_PulseGenerator = heli_q81_B.RateTransitionx - heli_q81_P.DeadZonex_End;
    } else if (heli_q81_B.RateTransitionx >= heli_q81_P.DeadZonex_Start) {
      rtb_PulseGenerator = 0.0;
    } else {
      rtb_PulseGenerator = heli_q81_B.RateTransitionx -
     ...
     *  Gain: '<S4>/Gain: x'
     */
    heli_q81_B.Joystick_gain_x = heli_q81_P.Gainx_Gain * rtb_PulseGenerator *
      heli_q81_P.Joystick_gain_x;

    /* Sum: '<S5>/Sum' */
    heli_q81_B.Sum = heli_q81_B.PitchCounttorad - heli_q81_B.Switch;
  }

  /* Sum: '<S5>/Sum3' */
  heli_q81_B.Sum3 = heli_q81_B.ElevationTransferFcn - heli_q81_B.Joystick_gain_y;
}
...
void heli_q81_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = heli_q81_B.Sum;

  /* Derivatives for Integrator: '<S5>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = heli_q81_B.Sum3;
...
void heli_q81_initialize(void)
{
  ...
  heli_q81_DW.clockTickCounter = -5000;

  /* Start for DiscretePulseGenerator: '<S2>/Pulse Generator1' */
  heli_q81_DW.clockTickCounter_m = -12500;
  ...
  heli_q81_X.Integrator_CSTATE = heli_q81_P.Integrator_IC;

  /* InitializeConditions for Integrator: '<S5>/Integrator1' */
  heli_q81_X.Integrator1_CSTATE = heli_q81_P.Integrator1_IC;
...
RT_MODEL_heli_q81_T *heli_q81(void)
{
...

  {
    ...
    rtsiSetNumPeriodicContStatesPtr(&heli_q81_M->solverInfo,
      &heli_q81_M->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr(&heli_q81_M->solverInfo,
      &heli_q81_M->ModelData.periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr(&heli_q81_M->solverInfo,
      &heli_q81_M->ModelData.periodicContStateRanges);
  ...
  /* External mode info */
  heli_q81_M->Sizes.checksums[0] = (2496235682U);
  heli_q81_M->Sizes.checksums[1] = (3212064123U);
  heli_q81_M->Sizes.checksums[2] = (3445363373U);
  heli_q81_M->Sizes.checksums[3] = (3748466484U);
...

  {
    ...
    heli_q81_B.ElevationTransferFcn = 0.0;
    heli_q81_B.Switch = 0.0;
    heli_q81_B.PitchCounttorad = 0.0;
    heli_q81_B.Gain[0] = 0.0;
    heli_q81_B.Gain[1] = 0.0;
    heli_q81_B.PitchTransferFcn = 0.0;
    heli_q81_B.Turnonofintegraleffect1off = 0.0;
    heli_q81_B.Gain_d[0] = 0.0;
    heli_q81_B.Gain_d[1] = 0.0;
    heli_q81_B.Switch_a = 0.0;
    heli_q81_B.Constant2 = 0.0;
    heli_q81_B.Constant2_k = 0.0;
    heli_q81_B.Constant2_e = 0.0;
    heli_q81_B.Sum1 = 0.0;
  ...
  /* Initialize Sizes */
  heli_q81_M->Sizes.numContStates = (5);/* Number of continuous states */
  heli_q81_M->Sizes.numPeriodicContStates = (0);/* Number of periodic continuous states */
  ...
  heli_q81_M->Sizes.numBlocks = (67);  /* Number of blocks */
  heli_q81_M->Sizes.numBlockIO = (25); /* Number of block outputs */
  heli_q81_M->Sizes.numBlockPrms = (176);/* Sum of parameter "widths" */
  return heli_q81_M;
}
