  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q81_P.PulseGenerator_Amp
	  section.data(10).logicalSrcIdx = 84;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_q81_P.PulseGenerator_Period
	  ...
	  ;% heli_q81_P.PulseGenerator_PhaseDelay
	  section.data(13).logicalSrcIdx = 87;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_q81_P.PulseGenerator1_Amp
	  section.data(14).logicalSrcIdx = 88;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_q81_P.PulseGenerator1_Period
	  section.data(15).logicalSrcIdx = 89;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q81_P.PulseGenerator1_Duty
	  section.data(16).logicalSrcIdx = 90;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_q81_P.PulseGenerator1_PhaseDelay
	  section.data(17).logicalSrcIdx = 91;
	  section.data(17).dtTransOffset = 16;
	
	  ;% heli_q81_P.Enablepitchsquare_Value
	  section.data(18).logicalSrcIdx = 92;
	  section.data(18).dtTransOffset = 17;
	
	  ;% heli_q81_P.Switch_Threshold
	  ...
	  ;% heli_q81_P.Integrator_IC
	  section.data(25).logicalSrcIdx = 99;
	  section.data(25).dtTransOffset = 24;
	
	  ;% heli_q81_P.Integrator1_IC
	  section.data(26).logicalSrcIdx = 100;
	  section.data(26).dtTransOffset = 25;
	
	  ;% heli_q81_P.Switch_Threshold_l
	  section.data(27).logicalSrcIdx = 101;
	  section.data(27).dtTransOffset = 26;
	
	  ;% heli_q81_P.Switch1_Threshold
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q81_B.ElevationTransferFcn
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	  ...
	  ;% heli_q81_B.Constant2
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 13;
	
	  ;% heli_q81_B.Constant2_k
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 14;
	
	  ;% heli_q81_B.Constant2_e
	  section.data(14).logicalSrcIdx = 13;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q81_DW.ElevationrateElevationrateref_P.LoggedData
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q81_DW.PitchPitchref_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 2;
	
	  ;% heli_q81_DW.Vd_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 4;
	
	  ;% heli_q81_DW.Vs_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 5;
	
	  ;% heli_q81_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 6;
	
	  ;% heli_q81_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 19;
	  section.data(6).dtTransOffset = 7;
	
	  ;% heli_q81_DW.PitchScoperad_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 20;
	  section.data(7).dtTransOffset = 8;
	
	  ;% heli_q81_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 21;
	  section.data(8).dtTransOffset = 9;
	
	  ;% heli_q81_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 22;
	  section.data(9).dtTransOffset = 10;
	
	  ;% heli_q81_DW.TravelScoperad_PWORK.LoggedData
  ...
  targMap.checksum0 = 2496235682;
  targMap.checksum1 = 3212064123;
  targMap.checksum2 = 3445363373;
  targMap.checksum3 = 3748466484;
