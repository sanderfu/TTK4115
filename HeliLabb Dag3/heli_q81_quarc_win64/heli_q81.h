...
#ifndef RTW_HEADER_heli_q81_h_
#define RTW_HEADER_heli_q81_h_
#include <string.h>
#ifndef heli_q81_COMMON_INCLUDES_
# define heli_q81_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_q81_COMMON_INCLUDES_ */

#include "heli_q81_types.h"
...
#define heli_q81_rtModel               RT_MODEL_heli_q81_T
...
typedef struct {
  ...
  real_T Turnonofintegraleffect1off;   /* '<Root>/Turn on//of integral effect (1=off)' */
  real_T Gain_d[2];                    /* '<S5>/Gain' */
  real_T Switch_a;                     /* '<Root>/Switch' */
  real_T Constant2;                    /* '<S6>/Constant2' */
  real_T Constant2_k;                  /* '<S5>/Constant2' */
  real_T Constant2_e;                  /* '<Root>/Constant2' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } ElevationrateElevationrateref_P;   /* '<Root>/Elevation rate + Elevation rate ref' */

  struct {
    void *LoggedData[2];
  } PitchPitchref_PWORK;               /* '<Root>/Pitch + Pitch ref' */
  ...
  int32_T clockTickCounter_m;          /* '<S2>/Pulse Generator1' */
...
#define rtB                            heli_q81_B
#define BlockIO                        B_heli_q81_T
#define rtX                            heli_q81_X
#define ContinuousStates               X_heli_q81_T
#define rtXdot                         heli_q81_XDot
#define StateDerivatives               XDot_heli_q81_T
#define tXdis                          heli_q81_XDis
#define StateDisabled                  XDis_heli_q81_T
#define rtP                            heli_q81_P
#define Parameters                     P_heli_q81_T
#define rtDWork                        heli_q81_DW
#define D_Work                         DW_heli_q81_T

/* Parameters (auto storage) */
struct P_heli_q81_T_ {
  ...
  real_T Enablepitchsquare_Value;      /* Expression: 1
                                        * Referenced by: '<S2>/Enable pitch square'
                                        */
  ...
  real_T PitchTransferFcn_D;           /* Computed Parameter: PitchTransferFcn_D
                                        * Referenced by: '<S3>/Pitch: Transfer Fcn'
                                        */
  real_T Turnonofintegraleffect1off_Valu;/* Expression: 0
...
extern P_heli_q81_T heli_q81_P;

/* Block signals (auto storage) */
extern B_heli_q81_T heli_q81_B;

/* Continuous states (auto storage) */
extern X_heli_q81_T heli_q81_X;

/* Block states (auto storage) */
extern DW_heli_q81_T heli_q81_DW;
...
extern void heli_q81_initialize(void);
extern void heli_q81_output0(void);
extern void heli_q81_update0(void);
extern void heli_q81_output(int_T tid);
extern void heli_q81_update(int_T tid);
extern void heli_q81_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q81_rtModel *heli_q81(void);
...
extern RT_MODEL_heli_q81_T *const heli_q81_M;
 ...
 *
 * '<Root>' : 'heli_q81'
 * '<S1>'   : 'heli_q81/Conversion'
 * '<S2>'   : 'heli_q81/Generate pitch ref'
 * '<S3>'   : 'heli_q81/Heli 3D'
 * '<S4>'   : 'heli_q81/Joystick'
 * '<S5>'   : 'heli_q81/Multivariable controller'
 * '<S6>'   : 'heli_q81/Multivariable controller no integral'
 */
#endif                                 /* RTW_HEADER_heli_q81_h_ */
