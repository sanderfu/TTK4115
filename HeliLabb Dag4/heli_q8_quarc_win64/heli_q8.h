...
typedef struct {
  ...
  struct {
    void *FilePtr;
  } ToFile3_PWORK;                     /* '<S10>/To File3' */

  struct {
    void *FilePtr;
  } ToFile4_PWORK;                     /* '<S10>/To File4' */
  ...
  struct {
    void *LoggedData;
  } accelerationx_PWORK;               /* '<S10>/acceleration x' */

  struct {
    void *LoggedData;
  } accelerationy_PWORK;               /* '<S10>/acceleration y' */

  struct {
    void *LoggedData;
  } accelerationz_PWORK;               /* '<S10>/acceleration z ' */
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK;                      /* '<S10>/To File' */

  struct {
    void *FilePtr;
  } ToFile1_PWORK;                     /* '<S10>/To File1' */

  struct {
    void *FilePtr;
  } ToFile2_PWORK;                     /* '<S10>/To File2' */

  struct {
    void *FilePtr;
  } ToFile5_PWORK;                     /* '<S10>/To File5' */

  struct {
    void *FilePtr;
  } ToFile6_PWORK;                     /* '<S10>/To File6' */

  struct {
    void *FilePtr;
  } ToFile7_PWORK;                     /* '<S10>/To File7' */
  ...
  struct {
    void *LoggedData[2];
  } elevationbetter_PWORK;             /* '<S10>/elevation  better' */
  ...
  struct {
    void *LoggedData[2];
  } pitchratebetter_PWORK;             /* '<S10>/pitch rate  better' */
  ...
  struct {
    void *LoggedData[2];
  } travelratebetter_PWORK;            /* '<S10>/travel rate  better' */

  struct {
    void *FilePtr;
  } ToFile8_PWORK;                     /* '<S10>/To File8' */
  ...
  int32_T clockTickCounter_j;          /* '<S2>/Pulse Generator1' */
  uint32_T HILInitialize_POSortedChans[8];/* '<Root>/HIL Initialize' */
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile3_IWORK;                     /* '<S10>/To File3' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile4_IWORK;                     /* '<S10>/To File4' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S10>/To File' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile1_IWORK;                     /* '<S10>/To File1' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile2_IWORK;                     /* '<S10>/To File2' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile5_IWORK;                     /* '<S10>/To File5' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile6_IWORK;                     /* '<S10>/To File6' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile7_IWORK;                     /* '<S10>/To File7' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile8_IWORK;                     /* '<S10>/To File8' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile9_IWORK;                     /* '<S10>/To File9' */
...
struct P_heli_q8_T_ {
  ...
  real_T _Y0;                          /* Expression: initCond
                                        * Referenced by: '<S8>/ '
                                        */
  real_T _Y0_c;                        /* Expression: initCond
                                        * Referenced by: '<S9>/ '
                                        */
  ...
  real_T PulseGenerator1_Duty;         /* Computed Parameter: PulseGenerator1_Duty
                                        * Referenced by: '<S2>/Pulse Generator1'
                                        */
  real_T PulseGenerator1_PhaseDelay;   /* Expression: 30
                                        * Referenced by: '<S2>/Pulse Generator1'
                                        */
 ...
 * '<S2>'   : 'heli_q8/Generate pitch ref'
 * '<S3>'   : 'heli_q8/Gyro vector to [pitch rate, elevation rate, tra vle rate]'
 * '<S4>'   : 'heli_q8/Heli 3D'
 * '<S5>'   : 'heli_q8/IMU'
 * '<S6>'   : 'heli_q8/Joystick'
 * '<S7>'   : 'heli_q8/Multivariable controller'
 * '<S8>'   : 'heli_q8/Sample and Hold'
 * '<S9>'   : 'heli_q8/Sample and Hold1'
 * '<S10>'  : 'heli_q8/Scop i Hop'
 */
